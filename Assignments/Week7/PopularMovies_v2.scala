...
object PopularMovies_v2 {
  ...
  def main(args: Array[String]) {
    ...
    // Exercise: Popular Movies: create the top 10 aggregated movies with number of ratings more than 200.
    
    //Top 200 based on counts
    val flipped_200 = flipped.filter(x => x._2 >=200)
    ...
    val sortedMovies = flipped_200.sortByKey(false).take(10)

object LearningScala1 {
  ...
  val hello: String = "Hello Buddy!"              //> hello  : String = Hello Buddy!
  println(hello)                                  //> Hello Buddy!
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Hello Buddy!
  helloThere = hello + " How is life?"
  println(helloThere)                             //> Hello Buddy! How is life?
  ...
  val immutableHelloThere = hello + "How is it going?"
                                                  //> immutableHelloThere  : String = Hello Buddy!How is it going?
  println(immutableHelloThere)                    //> Hello Buddy!How is it going?
